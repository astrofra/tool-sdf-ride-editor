...
"%~dp0build\vs2022-debug\bin\Debug\sdf_cli.exe" ^
  ...
  --out "%~dp0artifacts\generated\frame_006_blockout_dual_unwrapped.obj" ^
  --meshing-mode dual_contouring ^
  --unwrap-uvs ^
  --uv-resolution 2048 ^
  --uv-padding 8 ^
  --bake-ao "%~dp0artifacts\generated\frame_006_blockout_dual_ao.png" ^
  --bake-ao-samples 128 ^
